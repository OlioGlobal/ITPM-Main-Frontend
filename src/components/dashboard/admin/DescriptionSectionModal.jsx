...
export default function DescriptionSectionModal({
  isOpen,
  onClose,
  pageId,
  section,
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      if (section) {
        ...
        toast.success("Description section updated");
      } else {
        await dispatch(
          createSection({
            pageId,
        ...
        toast.success("Description section created");
      }
      ...
      <div className="bg-white w-full max-w-2xl">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 className="text-xl font-bold text-gray-900">
            {section ? "Edit" : "Add"} Description Section
          </h2>
          <button
            onClick={onClose}
