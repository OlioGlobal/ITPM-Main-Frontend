...
export default function CourseInfoSectionModal({
  isOpen,
  onClose,
  pageId,
  section,
  ...
  useEffect(() => {
    if (section?.data) {
      ...
      setValue("features", section.data.features || []);
    }
  }, [section, setValue]);
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      if (section) {
        ...
        toast.success("Course info section updated");
      } else {
        await dispatch(
          createSection({
            pageId,
        ...
        toast.success("Course info section created");
      }
      ...
      <div className="bg-white w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 sticky top-0 bg-white">
          <h2 className="text-xl font-bold text-gray-900">
            {section ? "Edit" : "Add"} Course Info Section
          </h2>
          <button
            onClick={onClose}
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                type="button"
                onClick={() =>
                  append({ icon: null, title: "", description: "" })
                }
                ...
                >
                  ...
                  <div className="space-y-3">
                    <CloudinaryUpload
                      ...
                      onChange={(value) =>
                        setValue(`features.${index}.icon`, value)
                      }
                    />
